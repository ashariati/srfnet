...
import data_utils
from data_utils import SintelSR
...
nvset = 100
training_set = 'sintel'
dataset = SintelSR('/mnt/tmp/data/sintel',
...
if start_epoch > 0:
    ...
    checkpoint_file = os.path.join(os.getcwd(), 'states', 'flying_chairs', 'srresnet_%d.pkl' % chairs_end_epoch)
    model.load_state_dict(torch.load(checkpoint_file))
